...
> Auto-generated by ai-agent-ecom v2.0.0 | 2026-04-14T07:35:40.699Z
...
> Single source of truth: Structured Reasoning, Architecture, Design System, Conversion Rules, and Data Handling
...
## Skill: animations
> High-performance UI animations and motion design patterns
...
## Skill: prompt-processing
> Transform all user prompts into Caveman Style before processing to reduce token usage
...
## Skill: domain-driven-architecture
> Enforce strict Domain-Driven Architecture (DDD) mirroring MedusaJS core design
...
> Strict internal Event-Driven Architecture layer to decouple UI from business logic
...
## Skill: service-layer-abstraction
> Simulate real backend API architecture using a strict frontend Service Layer abstraction
...
## Skill: enterprise-commerce-engine
> Upgrade to a MedusaJS-style scalable plugin engine, enforcing modular separation and robust full-stack API simulations
